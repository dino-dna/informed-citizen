            ...
            return (
              <div className='layout--body'>
                <AnalyzeArticleRequestForm
                  ...
                  onAnalzye={(url: string) => props.dispatch({ type: 'REQUEST_ANALYSIS', payload: { url } })}
                />
                ...
                {!!props.analysis.error &&
                  <div style={{marginTop: 20}} className='alert alert-danger' children={props.analysis.error} />
                }
              </div>
            )
          }}
        ...
        <Routable
          ...
          render={() =>
            <div
              ...
              style={{ margin: '80px auto 0' }}>cool beans</div>
          }
        />
      </Router>
    </div>
